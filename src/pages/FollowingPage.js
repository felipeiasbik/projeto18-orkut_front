                ...
                <InfoRight>
                    ...
                    <ButtonsInfos>
                        ...
                        <LinkIds to={`/followers/${id}`}>
                            <button>Seguindo {myTimeLine?.name.split(" ")[0]}</button>
                        </LinkIds>
                    </ButtonsInfos>
                </InfoRight>
            </MyInfos>
            <Content>
                <h1>Lista de quem {myTimeLine?.name.split(" ")[0]} segue:</h1>                
                {!myTimeLine?.following ? `Ainda não segue nenhum usuário.` 
                : myTimeLine?.following.map(({id, name, photo}) => (
                    <FollowList>
